...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add',app($dataType->model_name))
            <a href="{{ route($dataType->slug.'.create') }}" class="btn btn-success btn-add-new">
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
                                        ...
                                        @endcan
                                        @can('edit', $data)
                                            <a href="{{ route($dataType->slug.'.edit', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.edit') }}" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">{{ __('voyager.generic.edit') }}</span>
                                            </a>
                                        @endcan
                                        @can('read', $data)
                                            <a href="{{ route($dataType->slug.'.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.view') }}" class="btn btn-sm btn-warning pull-right">
